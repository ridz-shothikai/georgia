    ...
    try {
      ...
      if (usersResponse.ok) {
        ...
        setMetrics(prev => ({
          ...
          activeUsers: users.filter((user: any) => user.status !== 'inactive').length,
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  className={`h-2 rounded-full ${getStatusColor(metrics.cpuUsage)}`}
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  className={`h-2 rounded-full ${getStatusColor(metrics.memoryUsage)}`}
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  className={`h-2 rounded-full ${getStatusColor(metrics.diskUsage)}`}
            ...
            {activityLogs.map((log) => (
              <div key={log.id} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                <div className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs ${
                  ...
                  log.type === 'warning' ? 'bg-yellow-100' : 'bg-blue-100'
                }`}>
